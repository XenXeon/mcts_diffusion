...
SPECS: Dict[str, Dict[str, Any]] = {
    "maze2d": dict(
        H=32, stride=15, planner_depth=2, max_path_length=800, rebase_policy=True,
        ckpt=("results/veteran_d4rl_maze2d_H32_Jump15_next1_MCSS_transformer"
              "_d2_width256_separate_dpTrue")),
    "antmaze": dict(
        H=40, stride=25, planner_depth=8, max_path_length=1000, rebase_policy=True,
    ...
    "kitchen": dict(
        ...
        rebase_policy=False,   # kitchen obs dims 0-1 are joint angles, NOT xy —
        ckpt=("results/veteran_d4rl_kitchen_H32_Jump4_next1_MCSS_transformer"  # rebasing corrupts them (configs/veteran/kitchen/kitchen.yaml:21)
